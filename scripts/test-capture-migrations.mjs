  ...
  try {
    ...
    for (const file of files) {
      try {
        ...
        if (file.startsWith("0013") || file.startsWith("0014") || file.startsWith("0017") || file.startsWith("0019") || file.startsWith("0020") || file.startsWith("0021") || file.startsWith("0023")) {
    ...
    try {
      ...
      check("0013 + 0014 + 0017 + 0019 + 0020 + 0021 + 0023 are re-runnable (idempotent)", true);
    } catch (err) {
      check("0013 + 0014 + 0017 + 0019 + 0020 + 0021 + 0023 are re-runnable (idempotent)", false, String(err.stderr || err.message).slice(0, 800));
    }
