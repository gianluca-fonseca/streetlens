/**
 * Social card for the method route. Shape and styling come from the shared
...
export const alt =
  "The StreetLens method: how a walked street becomes a checkable score, lens by lens.";
