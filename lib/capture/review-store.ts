...
type ReviewPayload = {
  ...
  rollups: {
    ...
    /**
     * The segment synthesis, from the sibling engine (frozen contract, u2 seal #1;
     * its migration 0022 adds it to `capture_session_review`). Nullable/absent when
     * no synthesis was produced. Consumed verbatim.
     */
